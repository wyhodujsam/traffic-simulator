...
Plans:
- [ ] 15-01-PLAN.md — Fix test assertions (SQ-01) + refactor MapValidator (SQ-02, SQ-07)
- [ ] 15-02-PLAN.md — Refactor SnapshotBuilder, PhysicsEngine, TickEmitter, SimulationController (SQ-03, SQ-06)
